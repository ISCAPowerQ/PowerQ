...
model_list = ["facebook/opt-1.3b", "facebook/opt-6.7b", "microsoft/phi-2", "01-ai/Yi-6B", "meta-llama/Llama-2-7b-hf", "meta-llama/Meta-Llama-3-8B"]

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--is_generation", type=bool, default=False, help="If enabled, then evaluate")
    args = parser.parse_args()
    is_generation = args.is_generation

    w_prec_list = {
        'facebook/opt-1.3b': 3.875, 
        'facebook/opt-6.7b': 3.875, 
        'microsoft/phi-2': 4, 
        '01-ai/Yi-6B': 4.25, 
    ...
    if not is_generation:
        ...
        pe_array_dim = [batch_size, 84*16/batch_size]
